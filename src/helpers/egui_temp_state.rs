...
const NO_DATA: &'static str = "Presence of this type should assure presence of the value, unless someone went to Ui::data_mut directly, which I hereby strongly discourage.";
...
impl<T: Clone + Send + Sync + 'static> TempState<T> {
    ...
    pub fn finished(mut self, ui: Ui) {
        self.unwritten_data = false;
